...
<body>
    ...
    <div class="cont">
        <div class="cont1 reveal">
            <ul><img src="../immagini/title.png" alt=""></ul>
        </div>
        <div class="cont2">
            <ul class="med-text reveal">HAI DIMENTICATO LA PASSWORD? <br></ul>
            <ul class="normal-text reveal">non ti preoccupare</ul>
            <ul class="normal-text reveal">e-mail:<input type="text"><button onclick="lavatrice()">login</button></ul>
            <ul> inserisci la vecchia e-mail nell'apposito spazio, se hai ancora problemi rivolgiti al centro assistenza</ul>
